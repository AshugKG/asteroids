...
void Game::init() {
    ...
    for (int i = 0; i < 8; i++) {  // Increased number for more challenge
        // Asteroids will be randomly positioned by the reset() method
        asteroids.push_back(new Asteroid({0, 0}, GetRandomValue(15, 25)));  // Random sizes
    }
}
...
void Game::update() {
    ...
    // Add this debug code to check if space key is detected
...
void Game::draw() {
    BeginDrawing();  // Make sure this is here
